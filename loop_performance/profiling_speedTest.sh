...
valgrind  --tool=callgrind --callgrind-out-file=speed.profile --dump-instr=yes --dump-before=dlclose --instr-atstart=yes --collect-systime=yes $PROGRAM # | tee callgrindNN.log
