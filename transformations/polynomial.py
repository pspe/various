...
#            raise "Unknown argument to Polynomial: %s" % val
    ...
    def coefficients(self): return [self.plist[i]/self.plist[len(self.plist)-1] for i in xrange(len(self.plist)-1)]
...
## end of http://code.activestate.com/recipes/362193/ }}}
